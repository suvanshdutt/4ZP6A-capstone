...
class Metrics:
    ...
    def process_by_groups(self, group_size: int) -> None:
        ...
        '''
        self.losses = list(map(np.mean, np.array_split(self.losses, np.arange(group_size, len(self.losses), group_size))))
        self.accuracy = list(map(np.mean, np.array_split(self.accuracy, np.arange(group_size, len(self.accuracy), group_size))))
        self.precision = list(map(np.mean, np.array_split(self.precision, np.arange(group_size, len(self.precision), group_size))))
        self.recall = list(map(np.mean, np.array_split(self.recall, np.arange(group_size, len(self.recall), group_size))))
        self.f1 = list(map(np.mean, np.array_split(self.f1, np.arange(group_size, len(self.f1), group_size))))
        self.tp = list(map(np.mean, np.array_split(self.tp, np.arange(group_size, len(self.tp), group_size))))
        self.tn = list(map(np.mean, np.array_split(self.tn, np.arange(group_size, len(self.tn), group_size))))
        self.fp = list(map(np.mean, np.array_split(self.fp, np.arange(group_size, len(self.fp), group_size))))
        self.fn = list(map(np.mean, np.array_split(self.fn, np.arange(group_size, len(self.fn), group_size))))
